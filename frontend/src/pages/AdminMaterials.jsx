  ...
  <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
    <div className="bg-[#FFFFFF] w-full max-w-sm rounded-2xl shadow-2xl border border-[#E2E8F0] p-6 flex flex-col gap-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h3 className="text-[#232B32] font-bold text-base">Delete Material</h3>
      ...
      <p className="text-[#232B32] text-sm">
        ...
        <span className="font-semibold">{material.name}</span>? The material record and its
        image file will be removed from storage.
      </p>
